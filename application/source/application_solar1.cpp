...
/*
  Node* sunNode = m_scene.getRoot()->getChildren("sun");
  GeometryNode* sun = dynamic_cast<GeometryNode*>(sunNode);
*/
  renderPlanet(m_scene.getRoot()->getChildren("sun"), 0.0f, 1.0f);
  //renderPlanet(m_scene.getRoot()->getChildren("sun")->getChildren("planet1"), 10.0f, 2.4f);
  //renderPlanet(m_scene.getRoot()->getChildren("sun")->getChildren("planet2"), 5.0f, 1.0f);
}

void ApplicationSolar::renderPlanet(Node* planet, float distanceFromSun, float speed) const {
...
void ApplicationSolar::initializePlanets() {
  ...
  m_scene = SceneGraph("solarsystem", &root);
}
